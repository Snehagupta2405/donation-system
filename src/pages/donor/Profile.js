...
export default function DonorProfile() {
  ...
  const css = `
    ...
    .pf-btn{margin-top:10px; padding:12px 16px; border:none; border-radius:10px; background:#0ea5e9; color:#fff; font-weight:700; cursor:pointer}
    .pf-btn:hover{background:#0284c7}
